...
<body>
    ...
    <table id="ladu" border="1">
        ...
        <?php
			...
			// kuna postitamist pole veel toimunud, siis haldus.php failis if-lause ei ole tõene
            include 'haldus.php';
        ?>

        <?php
        // koolon tsükli lõpus tähendab, et tsükkel koosneb HTML osast
		// võetakse andmebaasi massiiv ja käiakse see ükshaaval läbindeks
		// indeks näitab rea indeksit ja rida sellel real olevaid väärtusi
        	...
        	<tr>
        		...
        		<td>
        			...
        			<form method="post" action="haldus.php">
						<!-- väärtuseks võetakse rea indeksi väärtus -->
